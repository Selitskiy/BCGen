function [mkImages, eLabels, mLabels, sLabels, mkDataSetFolders] = createBCFuzzTest5(dataFolderTmpl, dataFolderSfx, readFcn)
...
%mkDataSetFolders = [mkDataSetFolders, 'S3/S3NM/S3NM1AN'];
